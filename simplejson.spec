...
Version  : 3.18.1
Release  : 87
URL      : https://github.com/simplejson/simplejson/archive/v3.18.1/simplejson-3.18.1.tar.gz
Source0  : https://github.com/simplejson/simplejson/archive/v3.18.1/simplejson-3.18.1.tar.gz
...
%prep
%setup -q -n simplejson-3.18.1
cd %{_builddir}/simplejson-3.18.1
pushd ..
cp -a simplejson-3.18.1 buildavx2
popd
