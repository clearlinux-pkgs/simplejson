...
Version  : 3.19.3
Release  : 97
URL      : https://github.com/simplejson/simplejson/archive/v3.19.3/simplejson-3.19.3.tar.gz
Source0  : https://github.com/simplejson/simplejson/archive/v3.19.3/simplejson-3.19.3.tar.gz
...
%prep
%setup -q -n simplejson-3.19.3
cd %{_builddir}/simplejson-3.19.3
pushd ..
cp -a simplejson-3.19.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723654922
