...
%prep
%setup -q -n simplejson-3.17.6
cd %{_builddir}/simplejson-3.17.6
...
cp %{_builddir}/simplejson-3.17.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/simplejson/e0d52aebcf1a0f2270f61d29aebbaf29f8c91e2c
