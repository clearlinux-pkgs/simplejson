...
Version  : 3.20.1
Release  : 98
URL      : https://github.com/simplejson/simplejson/archive/v3.20.1/simplejson-3.20.1.tar.gz
Source0  : https://github.com/simplejson/simplejson/archive/v3.20.1/simplejson-3.20.1.tar.gz
...
%prep
%setup -q -n simplejson-3.20.1
cd %{_builddir}/simplejson-3.20.1
pushd ..
cp -a simplejson-3.20.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739812681
