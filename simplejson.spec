...
Source0  : https://github.com/simplejson/simplejson/archive/v3.18.3/simplejson-3.18.3.tar.gz
...
%prep
%setup -q -n simplejson-3.18.3
cd %{_builddir}/simplejson-3.18.3
pushd ..
cp -a simplejson-3.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675639811
